...
cubeSize = 100
cubeGap = 10
squareTop = [[-cubeSize, -cubeSize, (cubeSize + cubeGap)],
             [cubeSize, -cubeSize, (cubeSize + cubeGap)],
             [cubeSize, cubeSize, (cubeSize + cubeGap)],
             [-cubeSize, cubeSize, (cubeSize + cubeGap)]]
squareFront = [[(cubeSize + cubeGap), -cubeSize, cubeSize],
               [(cubeSize + cubeGap), -cubeSize, -cubeSize],
               [(cubeSize + cubeGap), cubeSize, -cubeSize],
               [(cubeSize + cubeGap), cubeSize, cubeSize]]
squareRight = [[cubeSize, (cubeSize + cubeGap), cubeSize],
               [cubeSize, (cubeSize + cubeGap), -cubeSize],
               [-cubeSize, (cubeSize + cubeGap), -cubeSize],
               [-cubeSize, (cubeSize + cubeGap), cubeSize]]
squareBack = [[-(cubeSize + cubeGap), cubeSize, cubeSize],
              [-(cubeSize + cubeGap), cubeSize, -cubeSize],
              [-(cubeSize + cubeGap), -cubeSize, -cubeSize],
              [-(cubeSize + cubeGap), -cubeSize, cubeSize]]
squareLeft = [[-cubeSize, -(cubeSize + cubeGap), cubeSize],
              [-cubeSize, -(cubeSize + cubeGap), -cubeSize],
              [cubeSize, -(cubeSize + cubeGap), -cubeSize],
              [cubeSize, -(cubeSize + cubeGap), cubeSize]]
squareBottom = [[cubeSize, cubeSize, -(cubeSize + cubeGap)],
                [-cubeSize, cubeSize, -(cubeSize + cubeGap)],
                [-cubeSize, -cubeSize, -(cubeSize + cubeGap)],
                [cubeSize, -cubeSize, -(cubeSize + cubeGap)]]
